...
| Orchestration | Python dataclasses, topological DAG ordering, retries |
| Persistence | SQLite run state and JSON task outputs |
| Live source | Open-Meteo forecast and current-weather API |
